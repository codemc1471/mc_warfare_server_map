...
- 원본 해상도: 표시 해상도 1블록당 1픽셀, 5000 × 5000 샘플
...
- 바이옴 ID와 바이옴 색상을 사용하지 않습니다.
- Cubiomes의 근사 고도 샘플만 사용해 산, 골짜기, 해안선을 음영 지형도로 표현합니다.
- 최종 타일 피라미드의 최대 레벨은 20,000 × 20,000 픽셀입니다.
- 원본 고도 샘플 간격은 4블록이며, 표시 타일은 1블록당 1픽셀로 보간됩니다.
